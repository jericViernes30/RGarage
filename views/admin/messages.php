...
?>
            ...
            <div class="w-3/4 h-full rounded-tr-xl flex flex-col rounded-br-xl bg-white">
                ...
                <div id="form" class="w-11/12 flex items-center mx-auto gap-4 py-4">
                    <svg class="hover:cursor-pointer" id="addImage" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width="20" height="20"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path d="M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32l0 144L48 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l144 0 0 144c0 17.7 14.3 32 32 32s32-14.3 32-32l0-144 144 0c17.7 0 32-14.3 32-32s-14.3-32-32-32l-144 0 0-144z"/></svg>
...
$('#imageInput').on('change', function() {
    ...
    if (file) {
        ...
        formData.append('receiver', senderName);

        $.ajax({
            url: '/RGarage/admin/send-image',  // Correct URL for image upload
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
