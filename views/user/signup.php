            ...
            <div class="w-full">
                ...
                <form id="signupForm" class="mb-10 text-white" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4 w-full flex items-center gap-4">
                        ...
                        <div class="w-1/3">
                            <label for="contac_number" class="text-sm">Contact Number</label>
                    ...
                    <div class="mb-4 w-full flex items-center gap-4">
                        ...
                        <div class="w-1/2">
                            <label for="repeat_password" class="text-sm">Repeat Password</label>
                            <div class="w-full relative">
                    ...
                    <div class="w-full flex flex-col mb-4">
                        <label for="" class="text-white text-sm">Select Profile Picture</label>
